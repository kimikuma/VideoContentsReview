...
ActiveRecord::Schema.define(version: 2024_12_11_104859) do
  ...
  create_table "tag_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id", "tag_id"], name: "index_tag_items_on_post_id_and_tag_id", unique: true
  ...
  create_table "vod_items", force: :cascade do |t|
    ...
    t.index ["vod_id", "post_id"], name: "index_vod_items_on_vod_id_and_post_id", unique: true
  ...
  create_table "vods", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["name"], name: "index_vods_on_name", unique: true
  end
