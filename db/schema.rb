...
ActiveRecord::Schema[7.2].define(version: 2024_11_30_130930) do
  ...
  create_table "notifications", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "notifiale_type", null: false
    t.integer "notifiale_id", null: false
    t.boolean "read", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["notifiale_type", "notifiale_id"], name: "index_notifications_on_notifiale"
